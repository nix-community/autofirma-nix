...
(function() {
    function initializeMiniApplet(storageUrl, retrieverUrl) {
        ...
        MiniApplet.setServlets(storageUrl, retrieverUrl);
    ...
    function startSigningProcess() {
        const storageUrl = 'https://autofirma-nix.com/afirma-signature-storage/StorageService';
        const retrieverUrl = 'https://autofirma-nix.com/afirma-signature-retriever/RetrieveService';
